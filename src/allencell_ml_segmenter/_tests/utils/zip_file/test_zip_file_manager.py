...
def test_unzip_zipped_file_and_delete_zip():
    ...
    with patch("allencell_ml_segmenter.utils.zip_file.zip_file_manager.ZipFile") as zipfile_mock:
        zipfile_mock.return_value.__enter__.return_value.extractall = mock_extract_all
