...
def test_update_channels_no_channels(
    qtbot: QtBot,
    main_model: MainModel,
    experiments_model: FakeExperimentsModel,
    training_model: TrainingModel,
    ...
    # ACT
    training_model.set_max_channel(None)

    # ASSERT
    assert not view.image_selection_widget._channel_combo_box.isEnabled()


def test_update_channels_with_channels(
    qtbot: QtBot,
    main_model: MainModel,
    experiments_model: FakeExperimentsModel,
    training_model: TrainingModel,
    ...
    # ACT
    training_model.set_max_channel(5)

    # ASSERT
    assert view.image_selection_widget._channel_combo_box.isEnabled()
    assert view.image_selection_widget._channel_combo_box.count() == 5
