...
class SelectionWidget(QWidget):
    ...
    def __init__(self, model: MainModel):
        ...
        self.training_button.clicked.connect(lambda: self.model.set_current_page(Page.TRAINING))
        self.prediction_button = QPushButton("Prediction View")
        self.prediction_button.clicked.connect(lambda: self.model.set_current_page(Page.PREDICTION))
